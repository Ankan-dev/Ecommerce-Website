...
function openLogin() {
    ...
    let error_message=document.createElement("p");
    error_message.textContent="username or password is incorrect";
    error_message.id="login-error-message";
    let message = document.createElement("p");
    message.id = "not-login-registered";
    ...
    registerForm.append(registerHead, user_name, password,error_message, submit_btn, message);
